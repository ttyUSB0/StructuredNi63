...
void PhysicsList::ConstructEM()
{
  ...
  em_config->SetExtraEmModel("e-","msc",msc,"Target",1*MeV,10*TeV); //*X********************* added emin, emax, flucModelName
  // https://www-zeuthen.desy.de/geant4/geant4.9.3.b01/classG4EmConfigurator.html#0d41e17678b9ffd8d789d79c6cfc2399
  
  mod = new G4MollerBhabhaModel();
  mod->SetActivationLowEnergyLimit(99.99*MeV);
  em_config->SetExtraEmModel("e-","eIoni",mod,"Target",1*MeV,10*TeV, new G4UniversalFluctuation()); //********************** changed emin, was 0.0
